...
const CourseLayout = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'prelims':
        return <PrelimsTestSeries selectedCategoryId={selectedCategoryId} selectedSubCategoryId={selectedSubCategoryId} />;
      case 'mains':
        return <MainsTestSeries selectedCategoryId={selectedCategoryId} selectedSubCategoryId={selectedSubCategoryId} />;
      case 'foundation':
      default:
      ...
      <Container fluid>
        <Row>
          ...
          <Col md={9} lg={10} className="p-4">
            <h3 className="td_fs_10 mt-4 ms-3">{subCategoryShow.name}</h3>
            {renderContent()}
          </Col>
        </Row>
      </Container>
