...
//     try {
//       const response = await axios.get(`https://backend-alic-3.onrender.com/enroll/getproducts/${id}`);
...
export const Enroll = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`https://backend-alic-3.onrender.com/enroll/${id}`, formData);
