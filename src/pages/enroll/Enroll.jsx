...
//     try {
//       const response = await axios.get(`https://backend-alic-4.onrender.com/enroll/getproducts/${id}`);
...
export const Enroll = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`https://backend-alic-4.onrender.com/enroll/${id}`, formData);
              ...
              <div className="contact-form p-4 shadow rounded bg-white w-100 h-100">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4">
                    ...
                    {errors.captchaToken && (
                      <div className="text-danger small mt-2">{errors.captchaToken}</div>
                    )}
                  </div>
