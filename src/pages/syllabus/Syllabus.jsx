...
//       try {
//         const res = await axios.get(`https://backend-alic-1.onrender.com/syllabus/category/${id}`);
...
//       await axios.post("https://backend-alic-1.onrender.com/register/add", formData);
