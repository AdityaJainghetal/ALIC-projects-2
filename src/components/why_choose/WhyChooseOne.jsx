...
export const WhyChooseOne = () => {
  ...
  const api = 'https://backend-alic-1.onrender.com/choose/display';
        ...
        <div className="row align-items-center td_gap_y_40">
            ...
            <div className="td_image_box td_style_1">
              ...
              <div className="td_avatars_wrap td_type_2 wow fadeInLeft">
                ...
                <div className="td_avatars">
                  ...
                  <div><img src={avatar4} alt="avatar" /></div>
                  <div className="td_avatar_end td_fs_18 td_medium td_center">10k+</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-6 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.4s">
            ...
            <ul className="td_list td_style_1 td_mp_0 td_semibold td_heading_color">
              {[item?.keywordone, item?.keywordtwo, item?.keywordthree, item?.keywordfour, item?.keywordfive, item?.keywordsix].map((keyword, index) =>
                keyword ? (
                  <li key={index}>
            ...
            <Link to="/contact" className="td_btn td_style_1 td_radius_30 td_medium">
              <span className="td_btn_in td_white_color td_accent_bg">
                <span>Get Started</span>
                <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M15.1575 4.34302L3.84375 15.6567" stroke="currentColor" />
                  <path d="M15.157 11.4142C15.157 11.4142 16.0887 5.2748 15.157 4.34311C14.2253 3.41142 8.08594 4.34314 8.08594 4.34314" stroke="currentColor" />
                </svg>
              </span>
            </Link>
          </div>
