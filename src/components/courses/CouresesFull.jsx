...
//       try {
//         setLoading(true);
//         const res = await axios.get(`https://backend-alic-4.onrender.com/api/courses${id}`);
...
//         const relatedRes = await axios.get(`https://backend-alic-4.onrender.com/api/courses?category=${res.data.category}&exclude=${id}`);
...
//         const courseResponse = await axios.get(`https://backend-alic-4.onrender.com/api/courses/${id}`);
...
//               `https://backend-alic-4.onrender.com/api/courses/related/${courseResponse.data.category}/${id}`
//             );
...
//   //       // Fetch related courses if category exists
//   //       if (courseResponse.data.category) {
//   //         const relatedResponse = await axios.get(`https://backend-alic-4.onrender.com/api/courses?category=${courseResponse.data.category}&limit=4`);
//   //         setRelatedCourses(relatedResponse.data);
//   //       }
//   //     } catch (err) {
//   //       console.error("Failed to fetch course:", err);
...
//         const relatedResponse = await axios.get(
//           `https://backend-alic-4.onrender.com/api/courses?category=${categoryId}&limit=4`
//         );
//         setRelatedCourses(relatedResponse.data);
//       }
//     } catch (err) {
...
//           // const relatedResponse = await axios.get(
//           //   `https://backend-alic-4.onrender.com/api/courses?category=${categoryId}&limit=4&exclude=${id}`
//           // );
//           // setRelatedCourses(relatedResponse.data);
//         }
//       } catch (err) {
...
const CouresesFull = () => {
  ...
  const sanitize = (dirty) => {
    return DOMPurify.sanitize(dirty, {
      ALLOWED_TAGS: ['p', 'strong', 'em', 'ul', 'ol', 'li', 'br', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'],
      ALLOWED_ATTR: []
    });
  };
            ...
            <Card.Body className="px-0 py-0">
              <div className="row g-0">
                ...
                <div className="col-md-7 p-4">
                  ...
                  <div className="mt-4">
                    <h4>Course Description</h4>
                    <div dangerouslySetInnerHTML={{ __html: sanitize(course.CourseDescription || "No description available.") }} />
                ...
                <div className="col-md-5 p-4 border-start">
                  ...
                  <div className="bg-light p-3 rounded-3 mb-4">
                    ...
                    <div className="mb-2">
                      <strong>📅 Start Date:</strong> 
                      <span className="ms-2">{formatDate(course.LastDate)}</span>
                    </div>
                    <div>
                      <strong>🎓 Level:</strong> 
                      <span className="ms-2">{course.level || "All levels"}</span>
