...
// //       try {
// //         const response = await fetch('https://backend-alic-4.onrender.com/judement/display');
// //         if (!response.ok) {
...
// //         // Example: `https://backend-alic-4.onrender.com/judement/display?categoryId=${categoryId}`
// //         const response = await fetch('https://backend-alic-4.onrender.com/judement/display');
// //         if (!response.ok) {
// //           throw new Error('Failed to fetch courses');
// //         }
  ...
  useEffect(() => {
    ...
    const filtered = allCourses.filter(judgment => {
      const categoryIdFromJudgment = 
        judgment.judementCategory?._id || 
        judgment.judementCategory;
      
      console.log(`Judgment ${judgment._id} has category:`, categoryIdFromJudgment); // Debug
