...
export const CoursesOne = () => {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        const response = await fetch('https://backend-alic-3.onrender.com/api/allcourse');
        if (!response.ok) {
            ...
            <SwiperSlide key={course._id || idx}>
              ...
              >
                <CoursesOneItem
                  ...
                  description={course.TrainerName|| "A competitive exam for Civil Judge recruitment."}
...
// export const CoursesOne = () => {
//   const [courses, setCourses] = useState([]);
//   const api = 'https://backend-alic-3.onrender.com/api/allcourse';
