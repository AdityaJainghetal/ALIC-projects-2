...
//     try {
//       setLoading(true);
//       const res = await axios.get(`https://backend-alic-3.onrender.com/api/coursess/${id}`);
//       const mainCourse = res.data;
//       setProduct(mainCourse);

//       const relatedRes = await axios.get(
//         `https://backend-alic-3.onrender.com/api/courses?category=${mainCourse.category._id}`
//       );
    ...
    const fetchCourseAndSameCategory = async () => {
      ...
      try {
        ...
        const sameCategoryRes = await axios.get(
          `https://backend-alic-3.onrender.com/api/courses/category/${main.category._id}`
        );
