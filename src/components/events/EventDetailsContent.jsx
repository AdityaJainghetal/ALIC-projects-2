...
export const EventDetailsContent = () => {
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      try {
        setLoading(true);
        const res = await axios.get(`https://backend-alic-4.onrender.com/event/${id}`);
        setEvent(res.data);
      } catch (err) {
        ...
        <div className="row td_gap_y_50">
          <div className="col-lg-8">
            <div className="td_card td_style_1 td_type_3">
              <img
                src={event.images && event.images[0] ? event.images[0] : eventThumb1}
                alt="Event thumbnail"
              ...
              <div className="td_card_info">
                <div className="td_card_info_in">
                  ...
                  <p className="td_mb_30 td_fs_18" dangerouslySetInnerHTML={{ __html: sanitizedDescription }} />
          ...
          <div className="col-lg-4">
            <div className="td_card td_style_6 td_white_bg td_radius_10">
              <img
                src={event.images && event.images[0] ? event.images[0] : eventThumb5}
                alt="Event thumbnail"
                className="td_radius_10 td_mb_20 w-100"
              />
              <h3 className="td_fs_20 td_semibold td_mb_10">Event Info</h3>
              <p className="td_mb_10 td_fs_18 td_mb_20" dangerouslySetInnerHTML={{ __html: sanitizedSubTitle }} />
              <div className="td_mb_30">
                <ul className="td_card_list td_mp_0 td_fs_18 td_semibold">
                  <li>
                    <span className="td_heading_color">Cost:</span>
                    <span className="td_accent_color">${event.Cost || '0'}.00</span>
                  </li>
                  <li>
