...
//       try {
//         setLoading(true);
//         const res = await axios.get(`https://backend-alic-4.onrender.com/test/preseries/${id}`);
//         console.log(res)
//         setProduct(res.data);
...
export const Pretestseries = ({ courseId }) => {
  ...
  return (
    ...
    <Layout header={9} >
    <section>
      <div style={{marginTop:"320px"}} className="td_height_10 td_height_lg_80" />
      <div className="container">
        {product.length === 0 ? (
          <div className="row td_gap_y_50">
            {/* Content Section */}
              ...
              <div className="col-lg-8">
                <div className="td_course_details">
                  ...
                  <div className="td_course_meta td_mb_40">
                    <div className="td_course_avatar">
                      <p className="td_heading_color mb-0 td_medium">
                        <span className="td_accent_color">Pre test:</span> Series
                      </p>
                    </div>
                    <div className="td_course_published td_medium td_heading_color">
                  ...
                  <div className="td_tabs td_style_1 td_mb_50">
                    ...
                    <div className="td_tab_body td_fs_18">
                      <div className="td_tab active" id="td_tab_1">
                        <h2 className="td_fs_48 td_mb_20">Pre test series</h2>
              ...
              <div className="col-lg-4 mt-5">
                <div className="td_card td_style_7">
                  <VideoPlayer
                    trigger={
                      <a href="" className="td_card_video_block td_video_open d-block">
                        <img src={item.images?.[0] || videoThumb} alt="Video thumbnail" />
                        <span className="td_player_btn_wrap_2">
                          <span className="td_player_btn td_center">
                            <span></span>
                          </span>
